        ...
        <div className="space-y-3">
            ...
            <div className="premium-card p-6 space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="premium-card p-1 flex bg-white/5 border-white/5 max-w-[140px] premium-trigger haptic-feedback">
                        <select
                            value={calculationMethod}
                            onChange={(e) => onUpdate({ calculationMethod: parseInt(e.target.value) })}
                            className="flex-1 bg-transparent text-[11px] font-black uppercase tracking-widest text-white/60 outline-none px-4 py-2 truncate cursor-pointer"
                        >
